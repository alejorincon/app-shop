    	...
    	<div class="section text-center section-landing">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <h5 class="description">Puedes revisar nuestra relación completa de productos, comparar precios y realizar tus pedididos cuando estés seguro.</h5>
                </div>
            </div>
				...
				<div class="row">
                    <div class="col-md-4">
						<div class="info">
							...
							<p>Atendemos rapidamente cualquier consulta que tengas via chat. No estás sólo, sino que siempre estamos atentos a tus inquietudes.</p>
						</div>
                    </div>
                    <div class="col-md-4">
						<div class="info">
							...
							<p>Todo pedido que realices será confirmado a través de una llamada. S no confias en los pagos en linea puedes pagar contra entrega el valor acordado.</p>
						</div>
                    </div>
                    <div class="col-md-4">
						<div class="info">
